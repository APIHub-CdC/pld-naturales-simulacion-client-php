...
namespace PLDNaturalesSimulacion\Client\Interceptor;
...
use \PLDNaturalesSimulacion\Client\Interceptor\KeyHandler;
use \PLDNaturalesSimulacion\Client\Interceptor\MyLogger;
use \PLDNaturalesSimulacion\Client\Model\Errors;
use \PLDNaturalesSimulacion\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\PLDNaturalesSimulacion\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \PLDNaturalesSimulacion\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \PLDNaturalesSimulacion\Client\Model\Errores(["errors" => [$error]]);
